...
const sorular = [
  {
    soru: "Mickey Mouse hangi şirkete aittir?",
    secenekler: ["Pixar", "DreamWorks", "Warner Bros", "Disney"],
    dogru: "Disney"
  },
  {
    soru: "Süper Mario karakteri hangi ülkede ortaya çıkmıştır?",
    secenekler: ["Japonya", "ABD", "Güney Kore", "İtalya"],
    dogru: "Japonya"
  }
];
