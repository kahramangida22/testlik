...
async function sorulariGetir() {
  const querySnapshot = await getDocs(collection(db, "bilgisayar"));
...
function sonrakiSoru() {
  ...
  document.getElementById("reklam-alani").innerHTML = `<p>🖥️ Yeni reklam - ${new Date().toLocaleTimeString()}</p>`;
}
