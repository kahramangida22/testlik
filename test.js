...
const sorular = [
  ...
  {
    soru: "HTML neyin kısaltmasıdır?",
    secenekler: ["Hyper Text Markup Language", "Home Tool Markup Language", "Hyperlinks and Text Markup Language", "Hollow Text Mark Language"],
    dogru: "Hyper Text Markup Language"
  }
];
